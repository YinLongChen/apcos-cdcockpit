...
SELECT
	nvl( T.WATER_AMOUNT, 0 ) AS WATER_AMOUNT,
	nvl( T.ELECTRIC_AMOUNT, 0 ) ELECTRIC_AMOUNT,
	nvl( T.WATER_AMOUNT, 0 ) + nvl( T.ELECTRIC_AMOUNT, 0 ) AS total,
	nvl( T.ETIME, T.WTIME ) AS TIME
FROM
	(
	SELECT
		w.WATER_AMOUNT,
