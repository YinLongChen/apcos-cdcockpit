...
CREATE TABLE "ODS_KV_MODEL_DATA" (
  ...
  "FILTER" VARCHAR2(32 BYTE),
  "REMARK" VARCHAR2(200 BYTE) ,
  CONSTRAINT "ODS_KV_MODEL_DATA_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_LAYOUT_CONFIG" (
  ...
  "ORDER" NUMBER(11) ,
  CONSTRAINT "ODS_LAYOUT_CONFIG_ID" PRIMARY KEY ("ID")
);
...
COMMENT ON COLUMN "ODS_LAYOUT_CONFIG"."LOGO" IS 'logo图片';
...
CREATE TABLE "ODS_LINK_MODEL_DATA" (
  ...
  CONSTRAINT "ODS_LINK_MODEL_DATA_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_LIST_MODEL_DATA_MAP" (
  ...
  CONSTRAINT "ODS_LIST_MODEL_DATA_MAP_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_LIST_MODEL_DATA_OPERATION" (
  ...
  CONSTRAINT "ODS_LIST_OPERATION_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_LIST_MODEL_VIEW" (
  ...
  CONSTRAINT "ODS_LIST_MODEL_VIEW_MODEL_ID" PRIMARY KEY ("MODEL_ID")
);
...
CREATE TABLE "ODS_MODEL_CONFIG" (
  ...
  CONSTRAINT "ODS_MODEL_CONFIG_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_MODEL_TYPE_CONFIG" (
  ...
  CONSTRAINT "ODS_MODEL_TYPE_CONFIG_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_MONITOR_MODEL_DATA" (
  ...
  "RTSP" VARCHAR2(200 BYTE) ,
  "DEVICE_NUM" VARCHAR2(36 BYTE) ,
  CONSTRAINT "ODS_MONITOR_MODEL_DATA_ID" PRIMARY KEY ("ID")
);
...
CREATE TABLE "ODS_RANKING_MODEL_DATA" (
  ...
  "MODEL_ID" VARCHAR2(36 BYTE) NOT NULL ,
  CONSTRAINT "ODS_RANKING_MODEL_DATA_ID" PRIMARY KEY ("ID")
);
